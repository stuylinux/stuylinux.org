...
All code snippets in this article can be pasted int to `jshell` to verify. Lone boolean expressions will always be true, so their meaning is always clear to the reader.
